// To parse this data:
//
//   import { Convert, SearchResponce } from "./file";
//
//   const searchResponce = Convert.toSearchResponce(json);
//
...
export class Convert {
  public static toSearchResponce(json: string): SearchResponce {
      return cast(JSON.parse(json), r("SearchResponce"));
  }

  public static searchResponceToJson(value: SearchResponce): string {
      return JSON.stringify(uncast(value, r("SearchResponce")), null, 2);
  }
}
